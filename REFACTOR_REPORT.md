...
### 5. Обновление окружения

*   В процессе работы столкнулась с тем, что некоторые пакеты (например `npm-check-updates`) требовали более новой версии Node.js.
*   **Подняла версию Node.js до 20.x.x** с помощью `nvm`. Это стандартная практика, чтобы использовать современные возможности языка и зависимостей.

**Почему это важно:** Работа на актуалных версиях инструментов это залог стабильности и безопасности.
